...
2. **热身与持拍发力**（第2-3章）：先完成身体准备和基础发力训练
3. **首次发球**（第4章）：学习发球与接发球的基本要求和常见错误
4. **基础击球**（第5-8章）：练习 Dink、Drop、Drive 和 Volley，建立稳定球感
5. **开始实战**（第16-17章）：带着单打和双打策略上场，边打边查阅第18-19章要点与 FAQ

> **导航说明**：仓库根目录的目录页会同时展示中文与英文两套章节；如果你希望连续阅读单一语言版本，请直接进入 [cn/README.md](cn/README.md) 或 [en/README.md](en/README.md)。
...
graph LR
    ...
    Ch1 --> Role3["竞技提高<br/>第1章 → 第9-17章 → 第23-24章"]
    Ch1 --> Role4["教练/进阶教学者<br/>第1-3章 → 第23-27章"]
