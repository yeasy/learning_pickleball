...
> - 🇨🇳 **[阅读中文版 (Read in Chinese)](cn/README.md)** [下载 pdf](https://github.com/yeasy/learning_pickleball/releases/latest)
> - 🇺🇸 **[Read in English (阅读英文版)](en/README.md)** [Download pdf](https://github.com/yeasy/learning_pickleball/releases/latest)
> - 📚 **[语言入口 / Language Index](LANGS.md)**：进入单语言版本的独立首页
...
Follow these steps to get oriented quickly / “5分钟了解匹克球”——跟随以下步骤快速掌握基础：

1. **What is pickleball / 什么是匹克球**（第1章）：了解匹克球的来源、特点和与其他球拍运动的区别
2. **Warm-up and paddle fundamentals / 热身与持拍发力**（第3-4章）：先完成身体准备和基础发力训练
3. **First serve / 首次发球**（第5章）：学习发球与接发球的基本要求和常见错误
4. **Core strokes / 基础击球**（第6-9章）：练习 Dink、Drop、Drive 和 Volley，建立稳定球感
5. **Start playing / 开始实战**（第17-18章）：带着单打和双打策略上场，边打边查阅第19-20章要点与 FAQ

> **Navigation / 导航说明**：仓库根目录的目录页会同时展示中文与英文两套章节；如果你希望连续阅读单一语言版本，请直接进入 [cn/README.md](cn/README.md) 或 [en/README.md](en/README.md)。
...
graph LR
    ...
    Ch1 --> Role3["竞技提高<br/>第1章 → 第9-18章 → 第21章"]
    Ch1 --> Role4["教练/进阶教学者<br/>第1-4章 → 第21章与附录六"]

    Role1 --> End1["入门基础技能"]
    Role2 --> End2["进阶战术应用"]
    Role3 --> End3["竞赛训练方法"]
    Role4 --> End4["教学与进阶训练能力"]
```

| Reader role / 读者角色 | Focus / 学习重点 | Outcome / 核心成果 |
|---------|---------|---------|
| **Complete beginner / 完全新手** | 第1-8章 | 掌握匹克球基础技能与规则 |
| **Racket-sport background / 有基础** | 第1-3章 → 第9-15章 | 快速迁移经验、学习进阶战术 |
| **Competitive improvement / 竞技提高** | 第1章 → 第9-18章 → 第21章 | 系统训练与比赛策略 |
| **Coach or advanced instructor / 教练/进阶教学者** | 第1-4章 → 第21章与附录六 | 教学设计、运动科学与装备决策支持 |
