...
This book has bilingual versions of [English](https://github.com/yeasy/learning_pickleball/releases/download/v2.6.2/learning_pickleball-v2.6.2-en.pdf) and [Chinese](https://github.com/yeasy/learning_pickleball/releases/download/v2.6.2/learning_pickleball-v2.6.2-cn.pdf). 本书提供 [中文版本](https://github.com/yeasy/learning_pickleball/releases/download/v2.6.2/learning_pickleball-v2.6.2-cn.pdf) 和 [英文版本](https://github.com/yeasy/learning_pickleball/releases/download/v2.6.2/learning_pickleball-v2.6.2-en.pdf)。
