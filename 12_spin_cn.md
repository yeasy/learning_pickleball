...
匹克球的旋转通常在 15 ~ 35 转/秒之间（网球可超 50 转/秒，乒乓球可超 100 转/秒）。随着原始碳纤维（Raw Carbon）表面球拍的普及，职业选手使用粗糙表面球拍可以打出更强的旋转，部分顶尖选手的上旋球可达 30 转/秒以上。球飞行也较慢，旋转对飞行轨迹影响不大，但会改变球触地后的运动方向。下图比较了常见球类的最快旋转和飞行速度。
...
* 颠球制造旋转：体会不同方向削球时制造的旋转；
* 发球制造旋转：击球不同位置，发出不同旋转球，观察落地后轨迹；
* 回球制造旋转：击球不同位置，回出不同旋转球，观察飞行轨迹；
* 多球训练：一方发特定旋转球，另一方击打到指定位置。
