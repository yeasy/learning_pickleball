...
- **Bert**：与 Erne 类似的跳跃截击，但球员跨过中线、移动到搭档一侧，在搭档身前的非截击区外跳起完成截击（即在搭档一侧打出的 Erne）。
...
- **Chicken Wing**：鸡翅式防守姿势，指来球靠近持拍侧身体时，球员不得不用弯曲的肘部挡球或回球，动作形状类似鸡翅。
...
- **Erne**：在 NVZ 侧边跳过或绕过非截击区进行截击，球员从非截击区侧边跳跃越过该区域，在对侧进行截击。
- **Fault**：过失，违反规则，导致回合结束。
- **Foam Core（泡沫核心）**：第四代（Gen-4）球拍核心技术，用整体泡沫（通常为发泡聚丙烯 EPP）取代传统蜂窝结构，提供更大甜区、更好的振动吸收和更高的耐久性。2025-2026 年最重要的球拍创新。
...
- **Let**：旧规则中的发球触网重发。按 USA Pickleball 2026 官方规则，发球触网后只要落入正确发球区就是继续比赛的活球，不再因触网本身重发。
...
- **Pickle**：匹克，比赛中对方没有获得任何分数。如果对方全程一次发球权都没拿到（同一发球员从 0-0 一直发到 11-0），被称为“黄金匹克（Golden Pickle）”。
...
- **Scorpion**：蝎尾式击球，球员快速下蹲、拍头从肩上扬起，对高于肩颈的来球做过顶进攻性回击（替代被动的防守反手）。通常用于处理网前对方打向己方头颈部高度的来球。
...
- **Supercritical Foam（超临界泡沫）**：一种新型球拍核心材料，通过将气体注入熔融聚合物产生均匀微泡，实现比传统 EPP 更轻的重量强度比。2025-2026 年新兴趋势。
...
- **Two-Bounce Rule**：两跳规则，发球后接发球方必须等球弹起后再回球（第一跳），发球方也必须等接发球回球弹起后再打第三拍（第二跳）；从第四拍开始，双方才可以截击。
