...
- **Bert**：在厨房区（Kitchen/NVZ）外、球网延长线之外跳跃截击，球员从非截击区外跳起，在空中击球并越过或绕过非截击区进行截击。
...
- **Pickle**：匹克，比赛中对方没有获得任何分数。如果对方在某一局或某一局的起点甚至没有得到发球机会（即 0-0 或对方首局 0 分开局），被称为“黄金匹克（Golden Pickle）”。
