...
> Note: Starting in 2025, the rules allow players to release the ball with their paddle (instead of only by hand), but imparting spin during the release is still prohibited. **The 2026 rules add the word "clearly" to the volley serve requirements: the hand must *clearly* be below the waist, the paddle head must *clearly* be swung in an upward arc, and the highest point of the paddle head must *clearly* not be above the wrist. This means borderline serves are now called faults rather than receiving the benefit of the doubt.** Regarding spin serves: spin generated by the paddle at the moment of contact is legal; however, manipulating the ball to add spin before the serve (e.g., finger-spinning or pre-spinning with the paddle) is prohibited—the once-popular "chainsaw serve" has been banned.
