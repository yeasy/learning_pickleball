...
1. **Four Basic Shots**
   ...
   - Serve (see [Chapter 5](05_serve.md)): 10 minutes multi-ball, 20-30 balls
   - Volley (see [Chapter 9](09_volley.md)): 10 minutes multi-ball, 30-50 balls
...
1. **Drop Shot Precision** (see [Chapter 6](06_dink.md) and [Chapter 7](07_drop.md))
...
2. **Volley Versatility** (see [Chapter 9](09_volley.md))
...
3. **Topspin and Backspin Mastery** (see [Chapter 13](13_spin.md))
...
1. **Basic Singles Tactics** (see [Chapter 17](17_single_strategy.md))
...
2. **Doubles Pairing Basics** (see [Chapter 18](18_double_strategy.md))
...
1. **Advanced Technique Exploration**
   - Begin learning ATP (around-the-post shots, see [Chapter 15](15_atp.md)) and Erne (see [Chapter 16](16_erne.md)) and other advanced techniques
