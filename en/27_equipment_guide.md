...
**Selection Method:**
When holding the paddle, there should be approximately half an inch (1.3 cm) of space between your index and ring finger.

**Grip Length:**
Standard length is 4.5-5.5 inches. Although rules allow longer grips, standard length is usually optimal.
...
## Ball Classification and Selection
