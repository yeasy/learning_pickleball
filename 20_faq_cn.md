...
如果对方挑球质量较高不容易拦截，应及时跑到球的侧后方，等球触地反弹后再击球。对方挑球后，注意力往往会放在网前等待截击。此时首选回球方式是后场吊球，或者挑后场到对方空档，尽量不要直接抽球。
...
## [Q10] 球要打到空档，具体是指哪里呢？
**答**：高水平运动员往往通过打空档而迫使对方失误。具体说来，有如下几种空档。

* **场地空档**：单打中常用，指的是远离对手的区域，可以迫使对手跑动回球；
* **技术空档**：指的是对方技术弱点区域，例如大部分人反手位置回球要弱，正手肩部位置回球要弱；
* **意图空档**：指的是对方意图判断不到的区域，例如对手提前预测，意图往反手位移动，此时正手位就出现意图空档；
* **配合空档**：双打中常用，指的是对方两名队员配合中难以决策的区域，例如两名球员之间区域，或都可以去接的区域；
* **战术空档**：指的是为实现战术意图而调动对手。例如主动回球到对方刚好够不到的位置，迫使对方回球过高，创造进攻机会。
